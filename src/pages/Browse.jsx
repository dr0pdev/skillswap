...
export default function Browse() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Header */}
      <div>
        <h1 className="section-title text-[#0C243D] mt-1">Browse Skills</h1>
      ...
      <div className="flex gap-2 border-b border-dark-800">
        <button
          ...
          className={`tab text-[#0C243D] mt-1 ${activeTab === SKILL_ROLES.TEACH ? 'tab-active' : ''}`}
        >
        ...
        <button
          ...
          className={`tab text-[#0C243D] mt-1${activeTab === SKILL_ROLES.LEARN ? 'tab-active' : ''}`}
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
